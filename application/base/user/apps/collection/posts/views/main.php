<section class="posts-page" data-up="<?php echo (get_option('upload_limit')) ? get_option('upload_limit') : '6'; ?>" data-mobile-installed="<?php echo (get_user_option('mobile_installed')) ? '1' : '0'; ?>">
    <nav>
                            ...
                            <div class="row">
                                <div class="col-xl-12 input-group composer-accounts-search">
                                    ...
                                    <?php if (get_user_option('settings_display_groups')) : ?>
                                        <input type="text" class="form-control composer-search-for-groups" placeholder="<?php echo $this->lang->line('search_for_groups'); ?>">
                                    <?php else : ?>
                                        <input type="text" class="form-control composer-search-for-accounts" placeholder="<?php echo $this->lang->line('search_for_accounts'); ?>">
                                    <?php endif; ?>
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <?php
                                                if ( get_user_option('settings_hashtags_suggestion') ) {
                                                    ?>
                                                <button type="button" class="btn" data-toggle="modal" data-target="#hashtags-sugestion">
                                ...
                                <div class="col-xl-12 post-preview-header">
                                    <h3>
                                        ...
                                        <div class="dropdown show">
                                            <a class="btn btn-secondary btn-md dropdown-toggle" href="#" data-slug="default" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="icon-screen-desktop"></i>
                                                <?php echo $this->lang->line('posts_default'); ?>
                                            </a>

                                            <div class="dropdown-menu dropdown-menu-social-preview" aria-labelledby="dropdownMenuLink">
                    ...
                    <div class="col-xl-12">
                        <div class="col-xl-12 clean">
                            <ul class="nav nav-pills">
                                <li class="active">
                                    <a href="#insights-posts" class="active show" data-toggle="tab"><?php echo $this->lang->line('posts'); ?></a>
                                </li>
                                <li>
                                    <a href="#insights-accounts" data-toggle="tab"><?php echo $this->lang->line('accounts'); ?></a>
                                </li>
                            </ul>
                                        ...
                                        <div class="col-xl-3">
                                            <div class="row">
                                                <div class="col-xl-12 input-group insights-posts-search">
                                                    ...
                                                    <input type="text" class="form-control insights-search-for-posts" placeholder="<?php echo $this->lang->line('search_for_posts'); ?>">
                                                            ...
                                                            <h3>
                                                                ...
                                                                <div class="dropdown show">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                        <a class="dropdown-item insights-post-delete-post" href="#"><?php echo $this->lang->line('delete_post'); ?></a>
                                                                    </div>
                                                                </div>
                                                            </h3>
                                                        </div>
                                        ...
                                        <div class="col-xl-3">
                                            <div class="row">
                                                <div class="col-xl-10 col-sm-10 col-9 input-group insights-posts-search">
                                                    ...
                                                    <input type="text" class="form-control insights-search-for-accounts" placeholder="<?php echo $this->lang->line('search_for_accounts'); ?>">
                                        ...
                                        <div class="col-xl-5">
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="panel theme-box no-selected-post panel-primary">
                                                        <div class="panel-no-selected-post">
                                                            <p class="no-post-selected"><?php echo $this->lang->line('no_accounts_selected'); ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="panel theme-box panel-primary">
                                        <div class="panel-heading" id="accordion">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-3 text-right">
                                                    <div class="dropdown show">
                                                        <a class="btn btn-post-actions btn-md dropdown-toggle" href="#" data-slug="default" role="button" id="dropdown-post-content" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            <i class="icon-arrow-down"></i>
                                                        </a>
                                                        <div class="dropdown-menu" aria-labelledby="dropdown-post-content">
                                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#posts-edit-post">
                                                                <i class="icon-note"></i>
                                ...
                                <div class="panel-heading" id="accordion">
                                    ...
                                    <div class="dropdown show">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-action" aria-labelledby="dropdownMenuLink">
                                            <a class="dropdown-item" data-id="1" href="#"><i class="fas fa-circle"></i> <?php echo $this->lang->line('enable'); ?></a>
                                            <a class="dropdown-item" data-id="2" href="#"><i class="far fa-circle"></i> <?php echo $this->lang->line('disable'); ?></a>
                                            <a class="dropdown-item" data-id="3" href="#"><i class="icon-trash"></i> <?php echo $this->lang->line('delete'); ?></a>
                                        </div>
                                    </div>
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control search-for-rss-feeds" placeholder="<?php echo $this->lang->line('search_for_rss_feeds'); ?>" aria-label="search-for-rss-feeds">
                                    ...
                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#rss-feeds-new-rss"><i class="icon-feed"></i> <?php echo $this->lang->line('add_rss_feed'); ?></button>
                                </div>
                                <div class="panel-body">
    ...
    <div class="modal-dialog file-upload-box modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer text-right">
                <div>
                    <button type="button" class="btn btn-success categories-select" data-dismiss="modal"><?php echo $this->lang->line('posts_add_category'); ?></button>
                </div>
            </div>
        </div>
    </div>
...
if ( get_user_option('settings_hashtags_suggestion') ) {
    ?>
    <!-- Modal -->
    <div class="modal fade" id="hashtags-sugestion" tabindex="-1" role="dialog" aria-labelledby="hashtags-sugestion" aria-hidden="true">
        <div class="modal-dialog file-upload-box modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active show" id="nav-twitter-hashtags-tab" data-toggle="tab" href="#nav-twitter-hashtags" role="tab" aria-controls="nav-twitter-hashtags" aria-selected="true">
                            ...
                            <?php
                                if (plan_feature('instagram_insights')) {
                                    ?>
                                <a class="nav-item nav-link" id="nav-instagram-hashtags-tab" data-toggle="tab" href="#nav-instagram-hashtags" role="tab" aria-controls="nav-instagram-hashtags" aria-selected="false">
                ...
                <div class="modal-body">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade active show" id="nav-twitter-hashtags" role="tabpanel" aria-labelledby="nav-twitter-hashtags">
                            ...
                            <div class="row hashtags-search-form">
                                <div class="col-xl-7 col-sm-7 col-7">
                                    <div class="input-group hashtags-enter-hashtag">
                                        ...
                                        <input type="text" class="form-control hashtags-enter-word" placeholder="<?php echo $this->lang->line('enter_a_word'); ?>" required>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                <div>
                                    <button class="btn add-hashtags-to-posts"><i class="icon-plus"></i><?php echo $this->lang->line('add_to_post'); ?></button>
                                </div>
                            </div>
                        </div>
                        <?php
                            if (plan_feature('instagram_insights')) {
                                ?>
                            <div class="tab-pane fade" id="nav-instagram-hashtags" role="tabpanel" aria-labelledby="nav-instagram-hashtags">
                                <?php echo form_open('user/app/posts', array('class' => 'hashtags-search-form', 'data-csrf' => $this->security->get_csrf_token_name())) ?>
                                <div class="row hashtags-search-form">
                                    <div class="col-xl-7 col-sm-7 col-7">
                                        <div class="input-group hashtags-enter-hashtag">
                                            ...
                                            <input type="text" class="form-control hashtags-enter-word" placeholder="<?php echo $this->lang->line('enter_a_hashtag'); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-xl-5 col-sm-5 col-5">
                                        <button type="submit" class="hashtags-hashtag-find-btn">
...
if (get_option('app_facebook_ads_enable_posts_boosting') && get_option('app_facebook_ads_enable') && plan_feature('app_facebook_ads')) {
    ?>
    <!-- Modal -->
    <div class="modal fade" id="boost-post-on" tabindex="-1" role="dialog" aria-labelledby="boost-post-on-modal" aria-hidden="true">
        <div class="modal-dialog file-upload-box modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active show" id="nav-ad-boosts-tab" data-toggle="tab" href="#nav-ad-boosts" role="tab" aria-controls="nav-ad-boosts" aria-selected="true">
                                <i class="fas fa-project-diagram"></i>
                        ...
                        <div class="row rss-feeds-add-rss-form">
                            <div class="col-xl-7 col-sm-7 col-7">
                                <div class="input-group rss-feeds-enter-rss">
                                    ...
                                    <input type="text" class="form-control rss-feeds-enter-rss-url" placeholder="<?php echo $this->lang->line('enter_rss_url'); ?>" required>
                                </div>
                            </div>
                            <div class="col-xl-5 col-sm-5 col-5">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div>
                    ...
                    ?>
                    <button class="btn select-all-uploaded-media"><i class="icon-plus"></i><?php echo $this->lang->line('add_to_post'); ?></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control composer-search-for-saved-posts" placeholder="<?php echo $this->lang->line('search_for_posts'); ?>" aria-label="<?php echo $this->lang->line('search_for_posts'); ?>" aria-describedby="basic-addon2">
                    <div class="input-group-append">
...
if (get_option('app_posts_enable_scheduled')) {
    ...
    <div class="modal fade" id="planner-posts-scheduled-modal" tabindex="-1" role="dialog" aria-labelledby="planner-posts-scheduled-modal" aria-hidden="true">
        <div class="modal-dialog file-upload-box modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="planner-quick-schedule-modal" tabindex="-1" role="dialog" aria-labelledby="planner-quick-schedule-modal" aria-hidden="true">
        <div class="modal-dialog file-upload-box modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                                    ...
                                    <div class="col-xl-12 input-group quick-scheduler-accounts-search">
                                        ...
                                        <?php
                                            if (get_user_option('settings_display_groups')) {
                                                ...
                                                ?>
                                            <input type="text" class="form-control quick-scheduler-search-for-groups" placeholder="<?php echo $this->lang->line('search_for_groups'); ?> ">
                                        <?php
                                            } else {
                                                ?>
                                            <input type="text" class="form-control quick-scheduler-search-for-accounts" placeholder="<?php echo $this->lang->line('search_for_accounts'); ?>">
                                        <?php
                                            }
                                            ?>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <input type="text" class="quick-scheduler-title" placeholder="<?php echo $this->lang->line('enter_post_title'); ?>">
                            <textarea class="quick-new-post" placeholder="<?php echo $this->lang->line('share_what_new'); ?>"></textarea>
...
<div class="modal fade" id="insights-reply-comments" tabindex="-1" role="dialog" aria-labelledby="insights-reply-comments" aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form method="post" class="insights-posts-reactions-post-reply">
                            <div class="input-group">
                                <textarea class="form-control input-sm reactions-msg" placeholder="<?php echo $this->lang->line('enter_reply'); ?>"></textarea>
...
<!-- Modal -->
<div class="modal fade" id="posts-edit-post" tabindex="-1" role="dialog" aria-labelledby="posts-edit-post" aria-hidden="true">
    <div class="modal-dialog file-upload-box modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="posts-edit-post-form-input">
                            <input type="text" class="posts-edit-post-title" placeholder="<?php echo $this->lang->line('enter_post_title'); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="posts-edit-post-form-input">
                            <input type="text" class="posts-edit-post-url" placeholder="<?php echo $this->lang->line('posts_enter_post_url'); ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="posts-edit-post-form-input">
                            <textarea placeholder="<?php echo $this->lang->line('posts_enter_post_content'); ?>" class="posts-edit-post-body"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
